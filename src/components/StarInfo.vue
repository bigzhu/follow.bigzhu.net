<template>
  <q-card v-if="star">
    ...
    <q-card-section>
      ...
      <q-input v-for="s in socialTypes" v-show="starSocial[s.socialType].SocialName!=''||!disableEdit"
               :key="s.socialType" v-model="starSocial[s.socialType].SocialName" @input="s.isEdit=true"
               :disable="disableEdit">
